...
Begin VB.Form frmCidadao 
   ...
   Begin prjChameleon.chameleonButton cmdCopy 
      ...
      MCOL            =   13026246
      MPTR            =   1
      MICON           =   "frmCidadao.frx":0C52
      PICN            =   "frmCidadao.frx":0C6E
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin prjChameleon.chameleonButton cmdGravar 
      ...
      MCOL            =   12632256
      MPTR            =   1
      MICON           =   "frmCidadao.frx":0D59
      PICN            =   "frmCidadao.frx":0D75
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin prjChameleon.chameleonButton cmdConsultar 
      ...
      MCOL            =   13026246
      MPTR            =   1
      MICON           =   "frmCidadao.frx":111A
      PICN            =   "frmCidadao.frx":1136
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin prjChameleon.chameleonButton cmdSair 
      ...
      MCOL            =   13026246
      MPTR            =   1
      MICON           =   "frmCidadao.frx":1290
      PICN            =   "frmCidadao.frx":12AC
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin prjChameleon.chameleonButton cmdCancel 
      ...
      MCOL            =   13026246
      MPTR            =   1
      MICON           =   "frmCidadao.frx":131A
      PICN            =   "frmCidadao.frx":1336
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin prjChameleon.chameleonButton cmdExcluir 
      ...
      MCOL            =   13026246
      MPTR            =   1
      MICON           =   "frmCidadao.frx":1490
      PICN            =   "frmCidadao.frx":14AC
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin prjChameleon.chameleonButton cmdAlterar 
      ...
      MCOL            =   13026246
      MPTR            =   1
      MICON           =   "frmCidadao.frx":154E
      PICN            =   "frmCidadao.frx":156A
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin prjChameleon.chameleonButton cmdNovo 
      ...
      MCOL            =   13026246
      MPTR            =   1
      MICON           =   "frmCidadao.frx":16C4
      PICN            =   "frmCidadao.frx":16E0
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin Tributacao.jcFrames jcFrames2 
      ...
      Begin prjChameleon.chameleonButton btPais2 
         ...
         MCOL            =   13026246
         MPTR            =   1
         MICON           =   "frmCidadao.frx":183A
         PICN            =   "frmCidadao.frx":1856
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
      ...
      Begin VB.ComboBox cmbUF2 
         Appearance      =   0  'Flat
         Height          =   315
         ItemData        =   "frmCidadao.frx":19B0
         Left            =   1080
         List            =   "frmCidadao.frx":19B2
         Sorted          =   -1  'True
         Style           =   2  'Dropdown List
         TabIndex        =   31
         Top             =   915
      ...
      Begin prjChameleon.chameleonButton cmdAddBairro2 
         ...
         MCOL            =   13026246
         MPTR            =   99
         MICON           =   "frmCidadao.frx":19D0
         PICN            =   "frmCidadao.frx":1CEA
         UMCOL           =   -1  'True
         SOFT            =   0   'False
         PICPOS          =   0
         NGREY           =   0   'False
   ...
   Begin VB.ListBox lstNomeLog 
      ...
      BackColor       =   &H00C0FFFF&
      Height          =   2175
      ItemData        =   "frmCidadao.frx":1E44
      Left            =   2280
      List            =   "frmCidadao.frx":1E46
      TabIndex        =   58
      Top             =   2205
      Visible         =   0   'False
      Width           =   5205
   ...
   Begin prjChameleon.chameleonButton btObservacao 
      ...
      MCOL            =   13026246
      MPTR            =   1
      MICON           =   "frmCidadao.frx":1E48
      PICN            =   "frmCidadao.frx":1E64
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
   ...
   Begin prjChameleon.chameleonButton btHistorico 
      ...
      MCOL            =   16711935
      MPTR            =   1
      MICON           =   "frmCidadao.frx":1EDE
      PICN            =   "frmCidadao.frx":1EFA
      UMCOL           =   -1  'True
      SOFT            =   0   'False
      PICPOS          =   0
      NGREY           =   0   'False
